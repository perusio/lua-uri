...
=item L<uri.ftp|lua-uri-ftp>

=item L<uri.http|lua-uri-http> and uri.https

=item L<uri.rtsp|lua-uri-rtsp> and uri.rtspu

=item L<uri.telnet|lua-uri-telnet>
...
=item L<uri._login|lua-uri-_login>
...
_relative
_util
possibly _ldap _query _segment
